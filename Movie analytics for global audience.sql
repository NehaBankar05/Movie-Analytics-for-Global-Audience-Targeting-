...
-- So, now that we know the top 10 movies, there can be character actors and filler actors from these movies?
...
-- Once again, trying to solve the problem given below.
